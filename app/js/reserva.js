...
var populateAparts = function() {
  var url = '//surerussolutions.com/divegold-webservice/rest/serrinha/apartype/',
...
var populateGases = function() {
  var url = '//surerussolutions.com/divegold-webservice/rest/gastype/',
...
var populateTanks = function() {
  var url = '//surerussolutions.com/divegold-webservice/rest/tanktype/',
    templateItem = "<li><a href='#' value={{id}}>{{type}}</a></li>";
...
var populateCombos = function() {
  ...
  var url = '//surerussolutions.com/divegold-webservice/rest/divertype/',
...
var initEvents = function() {
  ...
  $("#cpf").blur(function() {
    ...
    if (cpfValue) {
      var url = '//surerussolutions.com/divegold-webservice/rest/client/type=0&value=' + cpfValue + '/';
      $.getJSON(url, function(data) {
  ...
  $("#cnpj").blur(function() {
    ...
    if (cnpjValue) {
      var url = '//surerussolutions.com/divegold-webservice/rest/client/type=1&value=' + cnpjValue + '/';
      $.getJSON(url, function(data) {
        populateUserInfo(data);
      }).fail(function() {
